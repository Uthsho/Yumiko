module.exports = {
  help: {
    name: "volume",
    category: "music",
    description: "increase or lower volume!",
    Aliases: ["vl", "vol", "volum"],
    Usage: "volume 1/200"
  },
    run: async (client, message, args, prefix, ops) => {
        ...
        if(!args[0]) message.channel.send(`Volume is ${fetched.dispatcher.Volume}. Use d!volume <0/200> to increase volume`);
